...
[^1]: **Update (June 2026)**: Now that we're almost halfway into 2026 and I've managed to stick to something between the weekly and monthly blogging cadence I was aiming for, I hate the "Regular Reflections" tag a little more each time I see it. It's just too cutesy for my tastes. Since I'm tagging posts as I write them, I'm just gonna include a "week-notes" tag (or "month-notes", "fortnight-notes", etc) and let that serve the same purpose. I don't really plan on updating the content of past posts in general, but for the sake of more sensible post titles while scanning through them, I'm making an exception here.
